...
const resourceStats = ref({
  ...
  available: { value: 2, fullCard: 2, mig: 0, vgpu: 0, rate: 12.5 },
});

const columns = [
  { title: '租户/别名', dataIndex: 'tenant', key: 'tenant', width: 150 },
  { title: '存储', dataIndex: 'storage', key: 'storage', width: 180 },
...
const dataSource = ref([
  ...
  },
  {
    ...
    tenant: 'test01',
    alias: '-',
    storage: '5.00 GB / 5.00 GB',
    source: '分配',
    type: '整机分配',
    gpuResource: 'node201（NVIDIA-H100-HBM2E-80GB）',
    used: '0 节点 / 1 节点',
    expireTime: '-',
  },
  {
