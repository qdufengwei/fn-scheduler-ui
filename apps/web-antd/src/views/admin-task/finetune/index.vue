...
<template>
  <div class="min-h-full bg-gray-50 p-4">
    <Card class="mb-4"><Space><Button type="primary" @click="visible = true">创建微调任务</Button><Button>筛选</Button></Space></Card>
    <Card title="模型微调任务">
    ...
    <Drawer v-model:open="visible" title="创建微调任务" placement="right" width="420">
      ...
      <template #footer><Space><Button @click="visible = false">取消</Button><Button type="primary" @click="notify('已提交创建微调任务（原型）')">确认</Button></Space></template>
    </Drawer>
  </div>
</template>
