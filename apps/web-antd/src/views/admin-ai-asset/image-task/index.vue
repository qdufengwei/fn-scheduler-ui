...
const imageTasks = ref([
  ...
  {
    id: '3',
    name: 'pull-pytorch-2.3',
    source: 'Docker Hub',
    status: '已完成',
    node: 'node-01',
    createTime: '2026-03-13 09:10:00',
    finishTime: '2026-03-13 09:35:00',
  },
  {
    id: '4',
    name: 'build-deepspeed-img',
    source: '本地构建',
    status: '失败',
    node: 'node-03',
    createTime: '2026-03-12 16:00:00',
    finishTime: '2026-03-12 16:12:00',
  },
  {
    id: '5',
    name: 'pull-triton-server',
    source: 'NVIDIA NGC',
    status: '进行中',
    node: 'node-02',
    createTime: '2026-03-11 11:45:00',
    finishTime: '-',
  },
  {
    id: '6',
    name: 'pull-transformers',
    source: 'Docker Hub',
    status: '已完成',
    node: 'node-01',
    createTime: '2026-03-10 08:20:00',
    finishTime: '2026-03-10 08:42:00',
  },
  {
    id: '7',
  ...
  {
    id: '8',
    name: 'pull-diffusers-xl',
    source: 'Docker Hub',
    status: '已完成',
    node: 'node-03',
    createTime: '2026-03-08 10:15:00',
    finishTime: '2026-03-08 10:40:00',
  },
]);
