...
const customModels = ref([
  ...
  {
    id: 'M01KJSMH004AABBCCDD112233EE',
    name: 'deepseek-coder-ft',
    status: '已完成',
    progress: 100,
    version: 'V1',
    updateTime: '2026-03-10 16:45:12',
    user: 'test01',
    tenant: 'test01',
    alias: '代码助手模型',
  },
  {
    id: 'M01KJSMH005DDEEFF00112233GG',
    name: 'chatglm-medical',
    status: '上传中',
    progress: 72,
    version: 'V2',
    updateTime: '2026-03-12 08:30:55',
    user: 'admin',
    tenant: 'platform',
    alias: '医疗问答模型',
  },
  {
    id: 'M01KJSMH006GGHHII223344JJ55',
    name: 'yi-34b-lora',
    status: '已完成',
    progress: 100,
    version: 'V4',
    updateTime: '2026-03-14 11:20:38',
    user: 'test02',
    tenant: 'tenant-a',
    alias: '-',
  },
  {
    id: 'M01KJSMH007KKLLMM445566NN77',
    name: 'baichuan2-legal',
    status: '失败',
    progress: 0,
    version: 'V1',
    updateTime: '2026-03-15 13:05:44',
    user: 'test01',
    tenant: 'test01',
    alias: '法律咨询模型',
  },
  {
    id: 'M01KJSMH008OOPPQQ889900RR11',
    name: 'internlm2-math',
    status: '上传中',
    progress: 33,
    version: 'V3',
    updateTime: '2026-03-18 09:50:27',
    user: 'admin',
    tenant: 'platform',
    alias: '数学推理模型',
  },
