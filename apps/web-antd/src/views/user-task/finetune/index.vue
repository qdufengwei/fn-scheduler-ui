...
const rows = ref([
  { id: 'FT-1001', name: '客服场景微调', model: 'Qwen2-7B', status: '运行中', ready: 'Ready', duration: '1h 10m', created: '2026-05-26 11:20', instances: 2, gpu: 4, spec: 'A800' },
  { id: 'FT-1002', name: '法务语料微调', model: 'Llama3-8B', status: '成功', ready: 'Ready', duration: '3h 40m', created: '2026-05-25 14:03', instances: 1, gpu: 2, spec: 'A10' },
  { id: 'FT-1003', name: '医疗问答微调', model: 'ChatGLM3-6B', status: '排队中', ready: 'NotReady', duration: '-', created: '2026-05-27 09:00', instances: 1, gpu: 4, spec: 'A800' },
  { id: 'FT-1004', name: '代码助手微调', model: 'DeepSeek-Coder-33B', status: '失败', ready: 'NotReady', duration: '0h 45m', created: '2026-05-24 08:30', instances: 2, gpu: 8, spec: 'A100' },
]);
...
<template>
  ...
  <ListPageLayout>
    ...
    <template #toolbar>
      <Button type="primary" @click="router.push('/user-task/finetune/create')">
      ...
      <Popconfirm
        title="确认删除选中的任务？"
        @confirm="notify(`已删除 ${selected.length} 个任务`)"
      >
        ...
        <template v-if="column.dataIndex === 'action'">
          <Space :size="12">
            ...
            <a
              ...
              @click="record.status === '运行中' && notify(`停止微调任务 ${record.id}`)"
            >
              停止
            </a>
          </Space>
  ...
  <CreateDrawer>
    ...
    <template #footer>
      <Space>
        ...
        <Button
          type="primary"
          @click="notify('已提交创建微调任务'); createDrawerApi.close()"
        >
          确认
        </Button>
      </Space>
