...
const goBack = () => {
  router.push('/user-task/latest/training');
};
</script>
    ...
    <Card>
      ...
      <Form layout="vertical" class="px-2" :model="createForm">
        ...
        <FormItem label="实例配置" required>
          <Segmented
            :options="['MPI', 'PyTorch', 'Simple', 'CPU', 'Deployment']"
          />
            ...
            <table class="w-full text-left border-collapse">
              <thead>
                <tr class="bg-gray-50 text-sm">
                  ...
                  <th class="p-3 font-medium border-b border-gray-200 w-28">
                    实例数量
                  </th>
                  <th class="p-3 font-medium border-b border-gray-200 w-56">
                    资源规格
                  </th>
                  <th class="p-3 font-medium border-b border-gray-200 w-28">
                    GPU数量
                  ...
                  <th class="p-3 font-medium border-b border-gray-200 w-32">
                    内存(GiB)
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="p-3 border-b border-gray-200 text-gray-500">
                    master
                  </td>
                  ...
                  <td class="p-3 border-b border-gray-200">
                    <Input placeholder="CPU" class="w-full" />
                  </td>
                  <td class="p-3 border-b border-gray-200">
                    <InputNumber :value="1500" class="w-full" />
                  </td>
                </tr>
                <tr>
                  <td class="p-3 border-b border-gray-200 text-gray-500">
        ...
        <FormItem label="入口命令" required>
          <div
            class="bg-[#282c34] text-[#abb2bf] p-4 rounded font-mono text-sm leading-relaxed overflow-x-auto"
          >
            <div class="flex">
              <span class="text-gray-500 w-6 text-right mr-4 select-none"
                >1</span
              ><span class="text-[#e06c75]">/bin/bash</span>
            </div>
            <div class="flex">
              <span class="text-gray-500 w-6 text-right mr-4 select-none"
                >2</span
              ><span class="text-[#56b6c2]">-c</span>
            </div>
            <div class="flex">
              <span class="text-gray-500 w-6 text-right mr-4 select-none"
                >3</span
              ><span class="text-[#98c379]">sleep</span>
              <span class="text-[#d19a66]">inf</span>
            </div>
          </div>
          <div class="text-xs text-gray-400 mt-2 flex items-start">
            <Info class="mr-1 size-3 mt-0.5 shrink-0" /> Custom Mode 可输入
            Linux 命令 (参数以空格分隔，换行车换行) ; Shell Mode
            支持直接粘贴粘帖完整的 Shell 脚本。
          </div>
        </FormItem>
