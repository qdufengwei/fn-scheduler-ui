    ...
    <Card>
      ...
      <div class="flex items-center justify-between border-b pb-4 mb-4">
        <div class="flex items-center gap-2 cursor-pointer" @click="goBack">
          ...
          <span class="text-lg font-semibold text-gray-800">创建任务模板 - 高级切换</span>
        </div>
        <Space>
      ...
      <Form layout="vertical" class="px-2" :model="createForm">
        ...
        <FormItem label="描述">
          <Input.TextArea :rows="4" placeholder="请输入模板描述" :maxlength="1024" show-count />
        </FormItem>
        <FormItem label="容忍度">
      ...
      <div class="flex items-center justify-between mt-8 border-t pt-4">
        <Space>
          <Button type="primary" @click="notify('已提交创建任务模板')">确认</Button>
