...
import { Button, Input, Pagination, Popconfirm, Space, Table, message } from 'ant-design-vue';
import { ref } from 'vue';
...
const rows = ref([
  { id: 'TPL-01', name: '7B预训练模板', type: '分布式训练', image: 'ubuntu:20.04', gpu: 4, spec: 'A800', instances: 2, priority: '高', recycle: '保留', created: '2026-05-26 09:00' },
  { id: 'TPL-02', name: 'LLaMA微调模板', type: '单机训练', image: 'pytorch:2.0', gpu: 2, spec: 'A100', instances: 1, priority: '中', recycle: '删除', created: '2026-05-25 14:30' },
]);
...
<template>
  <ListPageLayout>
    ...
    <template #toolbar>
      <Button type="primary" @click="router.push('/user-task/training/template/create')">
      ...
      <template #bodyCell="{ column, record }">
        ...
        <template v-if="column.dataIndex === 'action'">
          <Space :size="12">
            ...
            <a @click="router.push('/user-task/training/template/create')">修改</a>
            <Popconfirm
              title="确认删除模板？"
              @confirm="notify(`删除模板 ${record.id}`)"
            >
