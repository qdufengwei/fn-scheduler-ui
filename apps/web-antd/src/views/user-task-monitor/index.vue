...
const metrics: MetricItem[] = [
  {
    ...
    title: 'CPU使用量',
    unit: '%',
    points: [8, 12, 15, 18, 17, 22, 24],
  },
  {
    key: 'memory',
    title: '内存使用量',
    unit: 'GB',
    points: [10, 10.4, 10.9, 11.2, 11.8, 12.1, 12],
  },
  {
    key: 'gpu',
    title: 'GPU利用率',
    unit: '%',
    points: [42, 48, 51, 57, 55, 60, 64],
  },
  {
    key: 'gpuMemory',
    title: 'GPU显存使用量',
    unit: 'GB',
    points: [16, 17, 17.4, 18.1, 18.5, 19, 19.2],
  },
  {
    key: 'networkIn',
    title: '网络入流量',
    unit: 'MB/s',
    points: [34, 39, 42, 37, 45, 48, 46],
  },
  {
    key: 'networkOut',
    title: '网络出流量',
    unit: 'MB/s',
    points: [22, 24, 23, 27, 31, 29, 32],
  },
  {
    key: 'diskRead',
    title: '磁盘读取',
    unit: 'MB/s',
    points: [72, 76, 80, 84, 82, 88, 91],
  },
  {
    key: 'diskWrite',
    title: '磁盘写入',
    unit: 'MB/s',
    points: [38, 40, 43, 41, 46, 49, 48],
  },
  {
    key: 'gpuTemp',
    title: 'GPU温度',
    unit: '℃',
    points: [52, 54, 55, 57, 56, 58, 59],
  },
];
      ...
      <section class="user-task-monitor__top">
        ...
        <div class="user-task-monitor__task-switch">
          ...
          <Select
            ...
            class="user-task-monitor__select"
            :options="taskTypeOptions"
          />
          <Select
            v-model:value="taskId"
            class="user-task-monitor__name-select"
        ...
        <div class="user-task-monitor__filter-left">
          <Space>
            ...
            <Select
              ...
              class="user-task-monitor__short-select"
          ...
          <Space>
            ...
            <RangePicker
              ...
              class="user-task-monitor__range"
            />
          </Space>
